...
DACAPO_2006_MINHEAP: dict[str, int] = {
    "antlr": 24, "bloat": 33, "eclipse": 84, "fop": 40,
    "xalan": 54, "jython": 40, "luindex": 22, "lusearch": 34,
    "pmd": 49, "sunflow": 54, "hsqldb": 127,
}

# DaCapo Chopin (23.11) minheap values — rough estimates
DACAPO_CHOPIN_MINHEAP: dict[str, int] = {
    "avrora": 32, "batik": 64, "biojava": 128, "cassandra": 256,
    "eclipse": 256, "fop": 32, "graphchi": 256, "h2": 512,
    "h2o": 256, "jython": 64, "kafka": 128, "luindex": 32,
    "lusearch": 64, "pmd": 128, "spring": 128, "sunflow": 64,
    "tomcat": 64, "tradebeans": 256, "tradesoap": 256, "xalan": 64,
    "zxing": 32,
}
