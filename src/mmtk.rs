...
pub static SFT_MAP: InitializeOnce<Box<dyn SFTMap + Send + Sync>> = InitializeOnce::new();
...
impl<VM: VMBinding> MMTK<VM> {
    ...
    ///
    /// This is safe because the caller must provide an `ExclusivePlanAccessProof` token
