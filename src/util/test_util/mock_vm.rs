...
use crate::plan::UnsupportedTracePolicy;
use crate::scheduler::gc_work::GCRootsWorkFactory;
...
/// `Box::new((MockMethod::<(&'static mut GCWorker<Self>,GCTracerContext<MockVM, UnsupportedTracePolicy<Self>>,),bool>::new_unimplemented())`.
///
...
impl Default for MockVM {
    fn default() -> Self {
        Self {
            ...
            // We instantiate a `MockMethod` with the arguments as GCRootsWorkFactory<..., UnsupportedTracePolicy<MockVM>, ...>,
            ...
            process_weak_refs: Box::new(MockMethod::<
                (
                    ...
                    GCTracerContext<MockVM, UnsupportedTracePolicy<MockVM>>,
                ),
                bool,
            >::new_unimplemented()),
            // Same here: the `MockMethod` is just a place holder. See the above comments.
