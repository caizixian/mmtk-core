...
impl ReferenceProcessor {
    ...
    pub fn forward<E: ProcessEdgesWork>(&self, trace: &mut E, worker: &mut GCWorker<E::VM>, _nursery: bool) {
        ...
        fn forward_reference<E: ProcessEdgesWork>(
            ...
            {
                let new_referent = ReferenceProcessor::trace_forward_object(trace, old_referent, worker);
            ...
            let new_reference = ReferenceProcessor::trace_forward_object(trace, reference, worker);
    ...
    fn retain<E: ProcessEdgesWork>(&self, trace: &mut E, worker: &mut GCWorker<E::VM>, _nursery: bool) {
        ...
        for reference in sync.references.iter() {
            ...
            {
                Self::keep_referent_alive(trace, referent, worker);
                num_retained += 1;
