...
pub const GLOBAL_SIDE_METADATA_BASE_ADDRESS: Address = Address::ZERO.add(0x1000_0000);
...
/// Global side metadata start address
pub const GLOBAL_SIDE_METADATA_BASE_ADDRESS: Address = Address::ZERO.add(0x0000_0c00_0000_0000usize);
