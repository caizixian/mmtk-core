...
pub type MarkingProcessEdges<VM> =
    PolicyDrivenProcessEdges<VM, PlanObjectTracePolicy<VM, Compressor<VM>, TRACE_KIND_MARK>>;
/// Forwarding trace
pub type ForwardingProcessEdges<VM> =
    PolicyDrivenProcessEdges<VM, PlanObjectTracePolicy<VM, Compressor<VM>, TRACE_KIND_FORWARD_ROOT>>;
