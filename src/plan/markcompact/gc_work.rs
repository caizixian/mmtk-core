...
pub type MarkingProcessEdges<VM> =
    PolicyDrivenProcessEdges<VM, PlanObjectTracePolicy<VM, MarkCompact<VM>, TRACE_KIND_MARK>>;
/// Forwarding trace
pub type ForwardingProcessEdges<VM> =
    PolicyDrivenProcessEdges<VM, PlanObjectTracePolicy<VM, MarkCompact<VM>, TRACE_KIND_FORWARD>>;
