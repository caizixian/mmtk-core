...
impl Block {
    ...
    pub fn load_free_list(&self) -> Address {
        unsafe { Address::from_usize(Block::FREE_LIST_TABLE.load_atomic::<usize>(self.start(), Ordering::SeqCst)) }
    }
    ...
    pub fn load_local_free_list(&self) -> Address {
        unsafe { Address::from_usize(Block::LOCAL_FREE_LIST_TABLE.load_atomic::<usize>(self.start(), Ordering::SeqCst)) }
    }
