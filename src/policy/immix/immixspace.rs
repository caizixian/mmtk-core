...
impl<VM: VMBinding> crate::policy::gc_work::PolicyTraceObject<VM> for ImmixSpace<VM> {
    ...
    fn may_move_objects<const KIND: TraceKind>() -> bool {
        if KIND == TRACE_KIND_DEFRAG {
            ...
            // This function is used by PolicyDrivenProcessEdges, and for sticky immix nursery GC,
            // we use GenNurseryTracePolicy. So it still works. But this is quite hacky anyway.
