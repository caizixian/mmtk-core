...
pub(crate) fn create_sft_map() -> Box<dyn SFTMap + Send + Sync> {
    cfg_if::cfg_if! {
...
mod dense_chunk_map {
    ...
    impl SFTMap for SFTDenseChunkMap {
        ...
        fn eager_initialize(&mut self, space: &(dyn SFT + Sync + 'static), start: Address, bytes: usize) {
