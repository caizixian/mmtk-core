...
## Refactoring Ideas
- Delete `src/util/rust_util/atomic_box.rs` as it is no longer used after refactoring `two_level_storage.rs` to use `OnceLock`. This will remove 6 unsafe blocks.
