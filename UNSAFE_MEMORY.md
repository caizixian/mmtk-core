...
## Progress
- Starting count: 722 | Current: 579 | Δ: -10 (Merged unsafe blocks in allocators.rs)
- Phase: 2
...
1. 🔴 HIGH: `src/util/metadata/side_metadata/global.rs:200-250` — Investigate if raw pointer casts and dereferences can be encapsulated or made safe. — expected Δ: unknown
