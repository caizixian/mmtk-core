...
## Progress
- Starting count: 722 | Current: 673 | Δ: -49
- Phase: 2
...
1. 🔴 HIGH: `src/util/metadata/side_metadata/global.rs` — Refactor to use `MetadataSlot` for side metadata access.
...
- **Safe Metadata Accessor**: `MetadataSlot` implemented in `metadata_val_traits.rs`. Used in `header_metadata.rs`.
