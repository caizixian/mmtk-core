...
## Progress
- Starting count: 351 | Current: 229 | Δ: -122
- Phase: 2
...
1. 🟢 LOW: `src/util/metadata/side_metadata/helpers.rs:90-110` — Check if test utilities can be refactored to use safer abstractions — expected Δ: 0
