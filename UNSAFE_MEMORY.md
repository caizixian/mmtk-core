...
## Progress
- Starting count: 722 | Current: 625 | Δ: -97
- Phase: 2
...
1. 🔴 HIGH: `src/util/metadata/side_metadata/global.rs` — Analyze remaining irreducible unsafe or document them.
2. 🟡 MED: Scan other tests for `SideMetadataSpec::load/store` that can be replaced with `load_atomic/store_atomic` to remove unsafe blocks.
